...
def locate_tissue(slides_dir,tissue_dir):
    slide_list = []
    ...
    # tissue_dir = os.path.join(os.path.dirname(slides_dir), "Visualization/255")
...
if __name__ == "__main__":
    slides_dir = os.path.join('/home/sdb/huangruiwei/data/Locate_tissue')
    tissue_dir = '/home/sdb/huangruiwei/data/Locate_tissue'
    locate_tissue(slides_dir,tissue_dir)
